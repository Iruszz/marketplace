            ...
            <div class="flex flex-col gap-8">
                <div>
                    ...
                    <input type="text" name="title" id="title" 
                        class="mt-2 block w-full max-w-md rounded-md border border-gray-300 px-3 py-2 text-base text-gray-900 focus:border-indigo-600 focus:ring-indigo-600 sm:text-sm 
                        @error('title') text-red-500 border-red-500 focus-within:border-red-500 focus-within:ring-red-500 @enderror" 
                ...
                <div class="grid grid-cols-3">
                    <div class="col-span-1">
                        ...
                        <select id="categoryId" name="category_ids[]" multiple
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-6">
                        <div class="sm:col-span-1">
                            <input id="is_premium" type="checkbox" name="is_premium" value="1" 
                                ...
                                @if(old('is_premium', $ad->is_premium) == 1) checked @endif>
