      ...
      <div class="mx-14 max-w-screen-3xl px-4 2xl:px-0">
        ...
        <div class="mb-4 items-end justify-between space-y-4 sm:flex sm:space-y-0 md:mb-8">
          <div class="flex items-center space-x-4">
            ...
            <button id="sortDropdownButton1" data-dropdown-toggle="dropdownSort1" type="button" class="flex w-full items-center justify-center rounded-lg border border-gray-200 bg-white px-3 py-2 text-sm font-medium text-gray-500 hover:bg-gray-100 hover:text-primary-700 focus:z-10">
            ...
            <form method="GET" action="{{ route('marketplace.index') }}" class="min-w-sm max-w-lg mx-auto">   
                ...
                <div class="relative flex items-center">
                    ...
                    <input type="text" name="q" value="{{ request('q') }}" placeholder="Search by title..." class="block w-full p-2 ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-white focus:ring-blue-500 focus:border-blue-500" placeholder="Search Mockups, Logos..." />
